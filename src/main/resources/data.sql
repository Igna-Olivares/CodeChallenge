...
insert into transaction(reference,account_iban,date,amount,fee,description) values('12345A','ES9820385778983000760236',1593503953149,183.2,3.18, 'Transaction');
